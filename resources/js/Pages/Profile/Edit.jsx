...
const LAYOUTS = {
    ...
    topnav: EcommerceLayout,
};

export default function Edit({ mustVerifyEmail, status, layout = 'sidebar' }) {
    const Layout = LAYOUTS[layout] ?? AuthenticatedLayout;
    ...
    return (
        <Layout>
            ...
            <div className={`${layout == 'topnav' ? 'p-10' : ''}`}>
                {/* Page header */}
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    ...
                    <div className="space-y-4">
                        {/* 2FA */}
                        <div className="rounded-2xl border border-outline-variant bg-surface p-6 shadow-sm">
                            <TwoFactorAuthenticationForm layout={layout} />
                        </div>
