...
const ProductiveStageFilterBar = ({ filters }) => {
    ...
    function handleChange(key, value) {
        ...
        setForm(next);
        router.get(route('productive-stages.index'), next, {
            preserveState: true,
            replace: true,
        });
    }
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <FilterField label="Nombre" icon="search">
                    ...
                    <input
                        ...
                        placeholder="Ej. Lactancia temprana"
...
export default ProductiveStageFilterBar;
