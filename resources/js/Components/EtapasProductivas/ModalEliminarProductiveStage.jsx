...
const ModalEliminarProductiveStage = ({ stage, onClose }) => {
    const { delete: destroy, processing } = useForm();

    function handleEliminar() {
        destroy(route('productive-stages.destroy', stage.id), {
            preserveScroll: true,
            onSuccess: onClose,
        });
    }
    ...
    return (
        <div className="p-6">
            ...
            <p className="text-center text-xs text-gray-400">
                Podrás restaurarla en cualquier momento desde el listado.
            </p>
...
export default ModalEliminarProductiveStage;
