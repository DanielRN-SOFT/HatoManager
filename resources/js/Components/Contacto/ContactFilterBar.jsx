...
const ContactFilterBar = ({ filters, topics }) => {
    ...
    function handleChange(key, value) {
        ...
        setForm(next);
        router.get(route('contacts.index'), next, {
            preserveState: true,
            replace: true,
        });
    }
    ...
    return (
        <div className="rounded-xl border-t-4 border-primary bg-white px-4 py-4 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                {/* Búsqueda */}
                <FilterField label="Nombre, email o asunto" icon="search">
                    ...
                    <input
                        ...
                        placeholder="Ej. Juan, juan@... o Consulta"
                ...
                {/* Tema */}
                <FilterField label="Tema" icon="topic">
                    <select
                        value={form.topic}
