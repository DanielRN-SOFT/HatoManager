...
import FilaContact from './FilaContact';

const ContactTable = ({ contacts, setModalDetalle, setModalEliminar }) => {
    ...
    const { data, current_page, last_page, total, per_page } = contacts;
