...
const ModalFormAnimalCategory = ({ category = null, onClose }) => {
    ...
    function handleSubmit(e) {
        ...
        if (isEdit) {
            put(route('animal-categories.update', category.id), options);
        } else {
            post(route('animal-categories.store'), options);
        }
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        placeholder="Ej. Ternero, Vaca de cría, Novillo..."
                        autoFocus
...
export default ModalFormAnimalCategory;
