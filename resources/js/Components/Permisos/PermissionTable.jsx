...
import FilaPermission from './FilaPermission';
import ModalEliminarPermission from './ModalEliminarPermission';
...
const PermissionTable = ({ permissions }) => {
    ...
    const { data, current_page, last_page, total, per_page } = permissions;
    ...
    return (
        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
            ...
            <Modal
                ...
                maxWidth="sm"
            >
                <ModalEliminarPermission
                    permission={modalEliminar}
                    onClose={() => setModalEliminar(null)}
                />
            </Modal>
                            ...
                            <tr>
                                <td colSpan={5} className="py-16 text-center">
                                    <div className="flex flex-col items-center gap-3 text-gray-400">
                                        ...
                                        <p className="text-sm">
                                            No hay permisos que coincidan con
                                            los filtros.
                                        </p>
                                    </div>
                                </td>
