const CardFarm = ({ farm, selected, onSelect }) => {
    ...
    return (
        <div
            onClick={onSelect}
            className={`${selected ? 'bg-on-primary-fixed-variant/20 border-l-primary border-l-4' : ''} group flex cursor-pointer items-center justify-between rounded-xl border border-surface-dim bg-white p-5 transition-all duration-200 hover:shadow-md`}
        >
