...
import FilaWeightMethod from './FilaWeightMethod';
import ModalEliminarWeightMethod from './ModalEliminarWeightMethod';
import ModalFormWeightMethod from './ModalFormWeightMethod';

const WeightMethodTable = ({ methods }) => {
    ...
    const { data, current_page, last_page, total, per_page } = methods;
...
export default WeightMethodTable;
